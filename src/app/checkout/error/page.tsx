...
export default function CheckoutErrorPage() {
  return (
    <main className="shell flex min-h-[72vh] flex-col items-start justify-center gap-5 py-16">
      ...
      <h1 className="text-5xl font-black uppercase leading-none md:text-7xl">{siteCopy.checkout.error.title}</h1>
      <p className="max-w-2xl text-lg text-[var(--muted)]">{siteCopy.checkout.error.copy}</p>
